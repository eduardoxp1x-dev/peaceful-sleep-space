    ...
    <section className="py-24 md:py-36 bg-gradient-hero">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="bg-gradient-card rounded-2xl p-10 border border-border mb-14 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <div className="p-5 rounded-lg bg-secondary/50 text-center">
              ...
              <p className="font-body text-muted-foreground text-base mt-2 leading-relaxed">Elimina tentativa e erro</p>
            </div>
            <div className="p-5 rounded-lg bg-secondary/50 text-center">
              <span className="font-body text-foreground font-medium">2. Regulagem do sistema nervoso</span>
              <p className="font-body text-muted-foreground text-base mt-2 leading-relaxed">Reduz o estado de alerta</p>
            </div>
            <div className="p-5 rounded-lg bg-secondary/50 text-center">
              <span className="font-body text-foreground font-medium">3. Recondicionamento</span>
              <p className="font-body text-muted-foreground text-base mt-2 leading-relaxed">Associa a cama com relaxamento</p>
            </div>
          </div>
                ...
                <ul className="space-y-3">
                  {module.items.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      ...
                      <span className="font-body text-muted-foreground text-base leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            {bonuses.map((bonus, index) => (
              <div key={index} className="flex items-start gap-5 p-5 rounded-lg bg-secondary/50">
                ...
                <div>
                  ...
                  <p className="font-body text-muted-foreground text-base leading-relaxed">{bonus.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mb-14 max-w-lg mx-auto">
          ...
          <p className="font-body text-muted-foreground text-center mt-6 text-base">
        ...
        <div className="bg-gradient-card rounded-3xl p-10 md:p-14 border border-border max-w-3xl mx-auto">
          <div className="grid md:grid-cols-3 gap-5 text-center mb-10">
            <div className="flex flex-col items-center gap-2.5">
              ...
              <span className="font-body text-base text-foreground font-medium">Garantia de 7 dias</span>
            ...
            <div className="flex flex-col items-center gap-2.5">
              ...
              <span className="font-body text-base text-foreground font-medium">Acesso imediato</span>
              <p className="font-body text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="flex flex-col items-center gap-2.5">
              ...
              <span className="font-body text-base text-foreground font-medium">Acesso vitalício</span>
              <p className="font-body text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="p-7 rounded-xl bg-primary/5 border border-primary/20">
            ...
            <p className="font-body text-muted-foreground text-center text-base leading-relaxed">
